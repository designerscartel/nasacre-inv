  ...
  <div>
          ...
          <div class="flex items-center justify-between" v-for="contact in contacts">
            ...
            <div class="flex items-center">
              <div class="ml-4 align-middle">
                ...
                <span class="bg-green-500 text-white text-xs inline-block rounded-full align-middle ml-2" v-if="contact.default">
    ...
    <jet-dialog-modal :show="showNewContactDialog" @close="showNewContactDialog = false">
      ...
      <template #content>
        ...
        <!-- Default -->
        <div class="mt-4">
          <jet-toggle type="toggle" class="mt-1 block w-full" v-model="addContactForm.default" :label="'Default'" :forid="'default'"/>
          <jet-input-error :message="addContactForm.error('default')" class="mt-2" />
        </div>
    ...
    <jet-dialog-modal :show="showUpdateContactDialog" @close="showUpdateContactDialog = false">
      ...
      <template #content>
        ...
        <!-- Default -->
        <div class="mt-4">
          <jet-toggle type="toggle" class="mt-1 block w-full" v-model="updateContactForm.default" :label="'Default'" :forid="'default'"/>
          <jet-input-error :message="updateContactForm.error('default')" class="mt-2" />
        </div>
