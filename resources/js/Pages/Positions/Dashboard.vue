                    ...
                    <div class="p-6 sm:px-8 bg-white border-b border-gray-200">
                        ...
                        <div class="mt-8 md:flex">
                            ...
                            <div class="md:w-1/6 text-right">
                                <inertia-link href="/positions/create" class="bg-gray-800 hover:bg-gray-7000 text-xs text-white font-semibold py-2 px-4 rounded transition ease-in-out duration-150">
                                    Create position
                                </inertia-link>
                            </div>
